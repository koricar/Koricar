...
// ============================================================
// MODEL GROUP MAP - يستخدم ModelGroup للبحث الشامل عن كل الأجيال
// ============================================================
const MODEL_GROUP_MAP: Record<string, string> = {
  ...
  "쏘렌토": "쏘렌토",
  "텔루라이드": "텔루라이드",
  "모하비": "모하비",   // ← يشمل تلقائياً: 모하비 + 더 뉴 모하비 + 모하비 더 마스터
  "셀토스": "셀토스",
  "니로": "니로",
  "쏘울": "쏘울",
  "카니발": "카니발",
...
// ============================================================
// EN_MODEL_TO_KR - الترجمة الكاملة إنجليزي/عربي → كوري
// ============================================================
...
function buildEncarQuery(params: {
  ...
  if (params.model) {
    ...
    if (isKorean) {
      ...
      if (group) {
        // استخدام ModelGroup للبحث الشامل عن كل الأجيال
